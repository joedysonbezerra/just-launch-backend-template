...
@injectable()
export class UpdateSubscriptionHandler implements IEventHandler<User> {
  className: string;
  ...
  constructor(
    ...
    this.className = 'UpdateSubscriptionHandler';
    this.eventType = 'customer.subscription.updated';
  }
