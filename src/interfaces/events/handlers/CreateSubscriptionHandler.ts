...
@injectable()
export class CreateSubscriptionHandler implements IEventHandler<User> {
  className: string;
  ...
  constructor(
    ...
    this.className = 'CreateSubscriptionHandler';
    this.eventType = 'customer.subscription.created';
  }
